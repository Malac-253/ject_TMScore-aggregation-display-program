        ...
        function putInreplysMedia(pData,Pastlink) {
            ...
            pData.forEach(function(aData){
               ...
               if(aData.ext == ".png"){
                    ...
                    .append("p")
                    .append("img")
                    .attr("src",function(aData){return ("https://i.4cdn.org.org/"+ Pastlink +"/"+aData.tim+aData.ext)})
                    .attr("alt","test")
                    .attr("height",(aData.h)/sizefix)
                    .attr("width",(aData.w)/sizefix)  
                }
        ...
        function putInreplys(pData,Datalink,Pastlink) {
                    ...
                    pData.forEach(function(element){
                        ...
                        if (!(element.filename == undefined)){ 
                            d3.select("#P"+element.idnum + element.chp)
                            .append("div")
                            console.log("https://i.4cdn.org.org/"+ Pastlink +"/"+element.tim+element.ext)
    ...
    // All video final Stufff
        ...
        async function checkimagesver(pData,nums){
            ...
            for (i = 0; i < pData.length; i++) {
                ...
                pData[i].verimageLINK = "https://i.4cdn.org.org/"+ pData[i].Pastlink +"/"+pData[i].tim+pData[i].ext    
                //console.log("https://i.4cdn.org.org/"+ pData[i].Pastlink +"/"+pData[i].tim+pData[i].ext);   
                }
           }
        }
        ...
        function mediaGetter(aData,Datalink,Pastlink){
                //console.log(aData)
                var imageLink = "https://i.4cdn.org.org/"+ aData.Pastlink +"/"+aData.tim+aData.ext 
                ...
                function videopostsetup(mainX,mainY,SVGobject,VidConfigs,text,i,oldpData,oldi){
                    ...
                    if (text[i].verimage){
                        ...
                        if(text[i].ext != ".webm"){
                            ...
                            d3.select("#configs_form_holder")
                            .append("img")
                            .attr("src",function(aData){return ("https://i.4cdn.org.org/"+text[i].Pastlink +"/"+text[i].tim+text[i].ext)})
