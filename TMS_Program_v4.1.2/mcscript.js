                ...
                if (pData[i].filename != undefined){
                    ...
                    if(pData[i].ext != ".webm"){
                       ...
                       //<img src="smiley.gif" alt="Smiley face" height="42" width="42"> 
                        ...
                        .text("Your browser does not support the video tag.")
                        .append("source")
                        .attr("src",function(aData){return ("https://i.4cdn.org/"+ pData[i].Pastlink +"/"+pData.tim+pData.ext)})
                        .attr("type","video/webm")
                    }
                }
            }
...
//                        }
                ...
                async function intropageOFF(text,i,VidConfigs){
                    if (testing){ //The Help notes
                        ...
                        //<svg id="svg_Video_holder" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" style="margin:auto;background:#222222;display:block;z-index:1;position:relative;margin-left: 0;" width="1920" height="1080" preserveAspectRatio="xMidYMid" viewBox="0 0 -1080 1920"></svg>
                        d3.select("#text_holder")
                            .append("svg")
                            .attr("id","svg_Video_holder")
